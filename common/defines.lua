...
NCountry = {
	...
	SEIZE_COURT_RESOURCES_SUBJECT_LOSS_MULTIPLIER = 0.75, --when seizing court resources through interaction, how much does the subject lose as a proportion of what the overlord gains
	MONTHS_OF_MANPOWER_FOR_SEIZE_COURT_RESOURCES = 9,
	...
	SEIZE_COURT_RESOURCES_MAX_LIBERTY_DESIRE = 20,
